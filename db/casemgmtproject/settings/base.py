...
ROOT_URLCONF = 'casemgmtproject.urls'
...
WSGI_APPLICATION = 'casemgmtproject.wsgi.application'
...
WQ_SCRIPT_FILE = os.path.join(BASE_DIR, 'htdocs', 'index.html')
