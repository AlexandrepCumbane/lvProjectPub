...
class Contactor(models.Model):
    ...
    alternative_number = models.TextField(default='', blank=True, null=True)
    ...
    fdp = models.TextField(max_length=200, default='', null=True, blank=True)
...
class ReferallEntity(models.Model):
    ...
    contact = models.TextField(default='', blank=True, null=True)
...
class Case(models.Model):
    ...
    other_vulnerabilites = models.TextField(max_length=200, null=True, blank=True)
    resettlement_name = models.TextField(max_length=200, null=True, blank=True)
    ...
    vulnerabilites = models.TextField(max_length=200, null=True, blank=True)
